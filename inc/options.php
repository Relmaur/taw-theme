...
new OptionsPage([
    ...
    'fields'     => [
        ...
        ['id' => 'company_address', 'label' => __('Company Address', 'taw-theme'), 'type' => 'textarea', 'width' => '100'],
        [
    ...
    'tabs' => [
        ['id' => 'general', 'label' => __('General', 'taw-theme'), 'fields' => ['company_name', 'company_phone', 'company_email', 'company_address', 'brand_primary_color']],
